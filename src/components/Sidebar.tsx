  ...
  return (
    <aside className="glass rounded-2xl p-4 md:p-5 flex flex-col gap-6">
      <div className="flex items-center gap-3">
        <div className="h-11 w-11 rounded-2xl bg-slate-800/45 border border-white/10 flex items-center justify-center text-primary font-semibold">
          AI
        </div>
        <div>
              ...
              `relative flex items-center gap-2 rounded-xl px-3.5 py-2.5 text-sm border transition ${
                item.locked
                  ...
                  : isActive
                    ...
                    : 'border-transparent bg-transparent text-slate-300 hover:bg-slate-800/40'
              }`
            }
            end={item.to === '/'}
          >
      ...
      <div className="glass rounded-xl p-3 border border-white/10 mt-auto">
