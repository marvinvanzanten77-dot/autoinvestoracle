 ...
 * Uses centralized data service with auto-loaded + manual-request data
 */
...
export function Today() {
  ...
  // ========================================================
  // AUTO-LOADED: Market data fetches automatically
  // ========================================================
  useEffect(() => {
    ...
    const interval = setInterval(loadAutoData, 60000);
